        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BlogPostType = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Products_Products_GeneralProductId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProviderName1 = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ProviderName2 = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ProviderPhone1 = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ProviderPhone2 = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ProviderMail1 = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ProviderMail2 = table.Column<string>(type: "nvarchar(max)", nullable: true),
